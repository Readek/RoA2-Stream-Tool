...
export class Player {
    ...
    async setIconImg() {
        ...
        promises.push(this.getBrowserSrc(this.char, this.skin, this.palette, "Icons", "Icon"));
            ...
            for (let i = 0; i < this.skinImgs.length; i++) {
                ...
                if (currentChar == this.char) {
                    ...
                    finalImg.src = await getCharImage(
                        ...
                        this.charInfo.skinList[i].nonFolder ? null : "Default",
                        "Skins",
                        "P2"
                    );
    ...
    async getBrowserSrc(char, skin, palette, extraPath, failPath) {
        ...
        if (await fileExists(`${stPath.char}/${char}/${extraPath}/${skin.name}/${palette}.png`)) {
